...
%From these genotyped markers, an augmented set of \NIMP variants was imputed. 
% The GWAS was performed across this dataset, in particular on the autosomes (chromosomes 1 through 22). The sex chromosomes (X and Y) require a special treatment and are left for future investigation.
...
% latter set, filtering by a minor allele frequency (MAF) threshold of \MAFTHR  and a HWE $p$-value threshold of \HWEPVAL, ending up with genetic variants.
